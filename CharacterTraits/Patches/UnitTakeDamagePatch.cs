...
namespace OrangePeelGGC2Mods.CharacterTraits.Patches
{
    ...
    public static class UnitTakeDamagePatch
    {
            ...
            int tick)
        {
            ...
            // 伤害倍率修正（原始伤害）
            float factor = 1f;
            if ((sourceUnitType == UnitTypeData.vinnie && (weaponType == WeaponTypeData.tommyGun || weaponType == WeaponTypeData.schmeisser  || targetUnitType.IsGangster || targetUnitType.IsZombie)) ||
            ...
            if (sourcePlayer != null &&
                ...
                sourcePlayer.Unit.IsCrouching)
            amount *= 1.25f; // 潜行攻击伤害加成
