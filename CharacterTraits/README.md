...
- Bonus damage against Government Forces and Police.
...
- High resistance to melee damage.
- Immune to melee knockback.
...
- Bonus damage with Flamethrower.
...
- This mod is built for game version **release_1.0.8** and modifies character-specific stats and abilities.
- May conflict with other mods that alter player character attributes. Use with caution.

## 🙏 Acknowledgements

Thanks to all testers and players for your valuable feedback.

## 📄 Changelog

### v1.0 (Initial Release)
- Introduced 12 unique character trait sets, each offering distinct playstyles and strategic advantages.
- Added special interactions including stealth eliminations, critical hits, stun effects, and more.
- Designed to encourage diverse character choices and replayability.
...
# 角色特质 (CharacterTraits)

本模组为《枪血意大利黑手党2》中的可玩角色引入了独特的特质系统。每位角色现在都拥有专属的能力、伤害加成、抗性和玩法特性，增加了策略深度，并鼓励玩家在不同对局中尝试多样化的风格。
...
- 本模组基于游戏版本 **release_1.0.8** 制作，修改了角色属性和能力。
- 若同时使用其他修改玩家角色属性的模组，可能会出现冲突，请谨慎搭配。
...
### v1.0（首发版本）
- 为 12 位角色引入独特特质，每位角色都拥有差异化的玩法和策略优势。
- 包含潜行秒杀、暴击、硬直、穿透等多种特殊交互机制。
- 旨在鼓励多样化的角色选择，提升重复游玩价值。
